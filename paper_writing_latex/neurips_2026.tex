...
and short-term reversal benchmarks; cumulative H--L performance; portfolio
...
Table~\ref{tab:table1} confirms the pattern evident in Figure~\ref{fig:fig7}
and the cumulative-return evidence in Figure~\ref{fig:fig8}: only the $I=5$
horizon delivers a
