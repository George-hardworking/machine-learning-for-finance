...
$6.62\%$ in D1 to $20.67\%$ in D10 (Figure~\ref{fig:fig6}), while the
...
and at $I=60$ the CNN ordering is essentially
flat ($11.95\%$ in D10 against $13.00\%$ in D1); corresponding plots are
provided in Appendix~\ref{app:fig6-horizons}.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.82\linewidth]{fig6_I5.png}
  \caption{Annualised decile returns at the $I=5$ horizon for the CNN,
    matched-horizon momentum, and moving-average cross signals. Reproduction
    of Figure~6(a) of the original paper; series are computed from the same
    out-of-sample prediction panels and rebalance calendar. Analogous plots
    for $I=20$ and $I=60$ are in Appendix~\ref{app:fig6-horizons}.}
  \label{fig:fig6}
\end{figure}
...
monthly-frequency pattern the original paper emphasises when comparing CNN
deciles to traditional signals. At $I=60$ the CNN ranking is nearly
horizontal, consistent with the well-documented attenuation of price-trend
signals at quarterly horizons (see Appendix~\ref{app:fig7-horizons}).
...
\section{Decile return plots for \texorpdfstring{$I=20$}{I=20} and \texorpdfstring{$I=60$}{I=60}}
\label{app:fig6-horizons}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.82\linewidth]{fig6_I20.png}
  \caption{Annualised decile returns at the $I=20$ horizon for the CNN,
    matched-horizon momentum, and moving-average cross signals. Reproduction
    of Figure~6(b) of the original paper.}
  \label{fig:fig6-i20}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.82\linewidth]{fig6_I60.png}
  \caption{Annualised decile returns at the $I=60$ horizon for the CNN,
    matched-horizon momentum, and moving-average cross signals. Reproduction
    of Figure~6(c) of the original paper. The CNN ordering is nearly flat
    across deciles at this horizon, consistent with the attenuation of
    price-trend signals at quarterly look-back windows.}
  \label{fig:fig6-i60}
\end{figure}
